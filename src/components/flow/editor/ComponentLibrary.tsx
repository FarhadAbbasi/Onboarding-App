...
const COMPONENTS = [
  {
    ...
    preview: <MobileText text="Amazing Headline" variant="h2" alignment="center" className="text-sm" />
  },
  {
    id: 'subheadline', 
    type: 'subheadline',
    ...
    preview: <MobileText text="Supporting text" variant="body" alignment="center" className="text-sm text-gray-600" />
  },
  {
    id: 'paragraph',
    type: 'paragraph',
  ...
  },
  {
    ...
    preview: <MobileButton text="Get Started" className="px-3 py-1 text-sm" />
  },
  {
    id: 'text-input',
    type: 'text-input',
    ...
    preview: (
      <div className="w-full">
        ...
        <MobileInput placeholder="Enter email..." className="text-xs w-full px-2 py-1" />
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    preview: (
      <div className="p-3 bg-white border border-gray-200 rounded-lg text-xs shadow-sm">
  ...
  },
  {
    ...
    preview: <div className="text-xs p-2 rounded bg-blue-50 text-blue-700 border border-blue-200">Info message</div>
  },
  {
    ...
    preview: (
      <div className="text-xs space-y-1">
        ...
        <MobileButton text="Allow" className="px-2 py-1 text-xs bg-green-600 hover:bg-green-700" />
      </div>
    )
  },
  {
  ...
  },
  {
    ...
    icon: '📱',
    category: 'interactive',
    description: 'Mobile-native bottom sheet modal',
    defaultContent: {
      title: 'More Information',
      content: 'Here you can provide additional details or actions in a native mobile bottom sheet.',
      trigger_text: 'Show Details',
      action_text: 'Got it!',
      variant: 'default'
    },
    preview: (
      <div className="space-y-2">
        <div className="w-full px-3 py-2 bg-blue-600 text-white text-xs rounded-lg text-center font-medium">
          Show Details
        </div>
        <div className="text-xs text-gray-600 italic">Tap to see bottom sheet</div>
      </div>
    )
  }
];
