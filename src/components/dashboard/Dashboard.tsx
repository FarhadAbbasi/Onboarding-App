...
import { MobileScreenEditor } from '../editor/MobileScreenEditor'
...
export function Dashboard() {
  ...
  const handleProjectCreated = (project: Project) => {
    ...
    // Go directly to the mobile screen editor since we already generated the mobile UI flow
    setShowMobileEditor(true)
    setShowNewProjectModal(false)
    toast.success('Project created! You can now edit your mobile UI screens.')
  }
  ...
  if (selectedProject && showMobileEditor) {
    return (
      <MobileScreenEditor
